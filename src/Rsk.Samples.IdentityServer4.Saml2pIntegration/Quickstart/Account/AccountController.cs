...
namespace Rsk.Samples.IdentityServer4.Saml2pIntegration.Quickstart.Account
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLogin(string provider, string returnUrl)
        {
            ...
            if (AccountOptions.WindowsAuthenticationSchemes.Contains(provider))
            {
                ...
                if (HttpContext.User is WindowsPrincipal wp)
                {
                    ...
                    await HttpContext.Authentication.SignInAsync(global::IdentityServer4.IdentityServerConstants.ExternalCookieAuthenticationScheme, new ClaimsPrincipal(id), props);
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            var info = await HttpContext.Authentication.GetAuthenticateInfoAsync(global::IdentityServer4.IdentityServerConstants.ExternalCookieAuthenticationScheme);
            ...
            await HttpContext.Authentication.SignOutAsync(global::IdentityServer4.IdentityServerConstants.ExternalCookieAuthenticationScheme);
